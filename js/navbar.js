window.addEventListener("load", function () {
  const menuHTML = `
    <div class="menu">
      ...
      <p class="navbarP"><a class="navbarA" href="./project.html" >Projects</a></p>
      <p class="navbarP"><a class="navbarA" href="https://forms.office.com/r/CwyyHHLfag" target="_blank">Project Voting</a></p>
      <p class="navbarP"><a class="navbarA" href="./direction.html">Getting to TP</a></p>
      <p class="navbarP"><a class="navbarA" href="./iit_courses.html" id="iit-courses-link">IIT Courses</a></p>
